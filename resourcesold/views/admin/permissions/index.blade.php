            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        @can('user-create')
                            <div>
                                <a href="{{  url('admin/permissions/create') }}" class="btn btn-primary btn-sm text-white mb-0 me-0"
                      ...
                      @foreach($permissions as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('permission-edit')
                                    <a href="{{ url('admin/permissions/' . $item->id . '/edit') }}" title="Edit permission"><button class="btn btn-primary btn-sm"><i class="fa fa-pen" aria-hidden="true"></i> Edit</button></a>
                                    @endcan
