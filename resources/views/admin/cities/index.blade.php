            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        @can('city-create')
                            <div>
                                <a href="{{  url('admin/cities/create') }}" class="btn btn-primary btn-sm text-white mb-0 me-0"
                    ...
                    <tbody>
                      ...
                      @foreach($cities as $item)
                            <tr>
                                ...
                                <td>
                                    @can('city-edit')
                                    <a href="{{ url('admin/cities/' . $item->id . '/edit') }}" title="Edit City"><button class="btn btn-primary btn-sm"><i class="fa fa-pen" aria-hidden="true"></i> Edit</button></a>
                                    @endcan
