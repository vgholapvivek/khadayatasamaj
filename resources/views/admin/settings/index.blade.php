            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        @can('user-create')
                            <div>
                                <a href="{{  url('admin/settings/create') }}" class="btn btn-primary btn-sm text-white mb-0 me-0"
                    ...
                    <tbody>
                      ...
                      @foreach($settings as $item)
                            <tr>
                                ...
                                <td>
                                    @can('setting-edit')
                                    <a href="{{ url('admin/settings/' . $item->id . '/edit') }}" title="Edit setting"><button class="btn btn-primary btn-sm"><i class="fa fa-pen" aria-hidden="true"></i> Edit</button></a>
                                    @endcan
